...
/** Adds the `is-visible` class to any `.reveal` element entering the viewport. */
...
/** Clearly labelled grey placeholder box for photos the client hasn't supplied yet. */
...
export function ScriptureBox({
  ...
  return (
    ...
    >
      ...
      <figcaption
        className={cn("mt-3 text-xs font-semibold", invert ? "text-gold-light" : "text-primary")}
      >
        {reference}
      </figcaption>
    </figure>
