...
const features = [
  {
    ...
    detail: "No admission fee, monthly fee or hostel fee.",
  },
  {
    icon: BookOpenCheck,
    label: "Deeni + Asri Taleem",
    detail: "Islamic sciences alongside contemporary studies.",
  },
  {
    icon: ShieldCheck,
    label: "Kanz-ul-Madaris",
    detail: "Affiliated with the Kanz-ul-Madaris board.",
  },
  {
    icon: Sparkles,
    label: "HEC Recognized",
    detail: "Dars-e-Nizami equivalent to M.A Arabic on completion.",
  },
];
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <Reveal>
            <SectionHeading
              ...
              title="A centre of Islamic learning in Khanqah Sharif"
            />
            <p className="mt-5 text-[15px] leading-7 text-muted-foreground">
              Jamia Tul Madina Khanqah Sharif is an Islamic educational institute operating under
              the Dawat-e-Islami Education Department. Students study the traditional Islamic
              sciences of Dars-e-Nizami while also completing contemporary Matric and F.A studies,
              all provided free of cost along with hostel accommodation and meals.
            </p>
          ...
          <Reveal delay={100} className="overflow-hidden rounded-md border border-border">
            <img
              src={img.campusFront}
      ...
      <Section tone="cream">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Reveal delay={100} className="rounded-md border border-border bg-card p-6 sm:p-8">
            ...
            <p className="mt-3 text-[15px] leading-7 text-muted-foreground">
              To raise scholars and students who serve their community with knowledge, humility
              and dedication, carrying forward the mission of Dawat-e-Islami.
            </p>
          </Reveal>
        </div>
