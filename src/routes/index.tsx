...
const slides = [
  { src: img.campusFront, alt: "Jamia Tul Madina campus front view" },
  { src: img.teachersGroup, alt: "Teachers of the Jamia" },
  { src: img.ijtema2, alt: "Ijtema gathering at the Jamia" },
  { src: img.ijtema1, alt: "Night ijtema at the Jamia" },
];
...
const leadership = [
  {
    ...
    photo: img.principal as string | undefined,
  },
  {
  ...
  return (
    <>
          ...
          <div className="animate-rise-delay">
            <div className="relative aspect-[4/3] overflow-hidden rounded-md border-[6px] border-background shadow-2xl">
              ...
              <img
                ...
                className="absolute bottom-3 right-3 h-16 w-16 rounded-full border-2 border-background bg-background object-cover sm:h-20 sm:w-20"
              />
            </div>
              ...
              {slides.map((slide, index) => (
                <button
                  ...
                  className={`h-2.5 w-2.5 rounded-full transition ${
                    active === index ? "bg-primary" : "bg-primary/25"
                  }`}
                />
              ))}
            </div>
      ...
      <Section tone="green">
        ...
        <Reveal className="mt-8 grid gap-6 rounded-md bg-primary-soft p-6 sm:p-8 lg:grid-cols-[0.75fr_1fr] lg:items-center">
          <img
            src={img.positionHolder}
            alt={`${featuredPosition.student} — Matric 2024 position holder`}
            loading="lazy"
        ...
        <Reveal className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
          <div>
            ...
            <p className="mt-3 max-w-xl text-[15px] leading-7 text-primary-foreground/75">
              Open for one month. Eligibility: 8th pass, age 12 years and above. No admission fee,
              no monthly fee, no hostel fee.
            </p>
          </div>
