/**
 * Central registry of all photographs served from `public/`.
 *
 * Every path here MUST match an actual file placed inside `public/`.
 * See `public/IMAGES.md` for the checklist and description of each photo.
 * If a file is missing the image will fail to render — the site still works.
 */
export const img = {
  logo: "/logo.jpeg",
  favicon: "/favicon.png",
