export const jamia = {
  ...
  facebook: "https://www.facebook.com/profile.php?id=100064371471945",
  address:
    "Jamia Tul Madina Faizan e Madina, K.L.P Road, Khanqah Sharif, Bahawalpur",
} as const;
...
/** The 8 items shown in the desktop header. All items appear in the mobile menu. */
...
/**
 * Numbers shown on the home page. All figures are drawn from data that appears
 * elsewhere on the site (student/hostel counts, years since 2010, board results).
 * Nothing is invented.
 */
export const stats = [
  { value: 200, suffix: "+", label: "Students" },
  { value: 120, suffix: "", label: "Residential" },
  { value: 15, suffix: "+", label: "Years of Service" },
  { value: 6, suffix: "+", label: "Board Positions" },
] as const;
